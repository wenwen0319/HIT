    ...
    for k_idx, edge_i in enumerate(edges.keys()): # first edge
        ...
        for l in adj_list[j]:
            ...
            if (l,i) in edges:
                ...
                if ((x3 > x2) or (x3 == x2 and x3_idx > x2_idx)) and (x3 - x1 < time_window):
                    l3 = 1
...
class TripletSampler(object):
    def __init__(self, cls_tri, opn_tri, wedge, nega, ts_start, ts_train, ts_val, ts_end, set_all_nodes, DATA, interpretation_type):
        """
        ...
        self.train_src_1_cls_tri, self.train_src_2_cls_tri, self.train_dst_cls_tri, self.train_ts_cls_tri, self.train_edge_idx_cls_tri = self.choose_idx(self.src_1_cls_tri, self.src_2_cls_tri, self.dst_cls_tri, self.ts_cls_tri_1, self.edge_idx_cls_tri_1, self.train_cls_tri_idx)
        self.val_src_1_cls_tri, self.val_src_2_cls_tri, self.val_dst_cls_tri, self.val_ts_cls_tri, self.val_edge_idx_cls_tri = self.choose_idx(self.src_1_cls_tri, self.src_2_cls_tri, self.dst_cls_tri, self.ts_cls_tri_1, self.edge_idx_cls_tri_1, self.val_cls_tri_idx)
        self.test_src_1_cls_tri, self.test_src_2_cls_tri, self.test_dst_cls_tri, self.test_ts_cls_tri, self.test_edge_idx_cls_tri = self.choose_idx(self.src_1_cls_tri, self.src_2_cls_tri, self.dst_cls_tri, self.ts_cls_tri_1, self.edge_idx_cls_tri_1, self.test_cls_tri_idx)

        self.train_src_1_opn_tri, self.train_src_2_opn_tri, self.train_dst_opn_tri, self.train_ts_opn_tri, self.train_edge_idx_opn_tri = self.choose_idx(self.src_1_opn_tri, self.src_2_opn_tri, self.dst_opn_tri, self.ts_opn_tri_1, self.edge_idx_opn_tri_1, self.train_opn_tri_idx)
        self.val_src_1_opn_tri, self.val_src_2_opn_tri, self.val_dst_opn_tri, self.val_ts_opn_tri, self.val_edge_idx_opn_tri = self.choose_idx(self.src_1_opn_tri, self.src_2_opn_tri, self.dst_opn_tri, self.ts_opn_tri_1, self.edge_idx_opn_tri_1, self.val_opn_tri_idx)
        self.test_src_1_opn_tri, self.test_src_2_opn_tri, self.test_dst_opn_tri, self.test_ts_opn_tri, self.test_edge_idx_opn_tri = self.choose_idx(self.src_1_opn_tri, self.src_2_opn_tri, self.dst_opn_tri, self.ts_opn_tri_1, self.edge_idx_opn_tri_1, self.test_opn_tri_idx)

        self.train_src_1_wedge, self.train_src_2_wedge, self.train_dst_wedge, self.train_ts_wedge, self.train_edge_idx_wedge = self.choose_idx(self.src_1_wedge, self.src_2_wedge, self.dst_wedge, self.ts_wedge_1, self.edge_idx_wedge_1, self.train_wedge_idx)
        self.val_src_1_wedge, self.val_src_2_wedge, self.val_dst_wedge, self.val_ts_wedge, self.val_edge_idx_wedge = self.choose_idx(self.src_1_wedge, self.src_2_wedge, self.dst_wedge, self.ts_wedge_1, self.edge_idx_wedge_1, self.val_wedge_idx)
        self.test_src_1_wedge, self.test_src_2_wedge, self.test_dst_wedge, self.test_ts_wedge, self.test_edge_idx_wedge = self.choose_idx(self.src_1_wedge, self.src_2_wedge, self.dst_wedge, self.ts_wedge_1, self.edge_idx_wedge_1, self.test_wedge_idx)

        # get negative samples(class 3)
        self.train_src_1_neg, self.train_src_2_neg, self.train_dst_neg, self.train_ts_neg, self.train_edge_idx_neg = self.choose_idx(self.src_1_neg, self.src_2_neg, self.dst_neg, self.ts_neg_1, self.edge_idx_neg_1, self.train_neg_idx)
        self.val_src_1_neg, self.val_src_2_neg, self.val_dst_neg, self.val_ts_neg, self.val_edge_idx_neg = self.choose_idx(self.src_1_neg, self.src_2_neg, self.dst_neg, self.ts_neg_1, self.edge_idx_neg_1, self.val_neg_idx)
        self.test_src_1_neg, self.test_src_2_neg, self.test_dst_neg, self.test_ts_neg, self.test_edge_idx_neg = self.choose_idx(self.src_1_neg, self.src_2_neg, self.dst_neg, self.ts_neg_1, self.edge_idx_neg_1, self.test_neg_idx)
    ...
    def choose_idx(self, a,b,c,d,e, idx):
    ...
    def train_samples(self):
        ...
        src_1_l_cut, src_2_l_cut, dst_l_cut, ts_l_cut, e_l_cut, label_cut = self.train_src_1[batch_idx], self.train_src_2[batch_idx], self.train_dst[batch_idx], self.train_ts[batch_idx], self.train_idx[batch_idx], self.train_label_t[batch_idx]
        self.idx += 1
    ...
    def val_samples(self, bs = None):
        ...
        src_1_l_cut, src_2_l_cut, dst_l_cut, ts_l_cut, e_l_cut, label_cut = self.val_src_1[batch_idx], self.val_src_2[batch_idx], self.val_dst[batch_idx], self.val_ts[batch_idx], self.val_idx[batch_idx], self.val_label[batch_idx]
        self.idx += 1
        # idx, label_cut = self.inter_label(label_cut)
        return src_1_l_cut, src_2_l_cut, dst_l_cut, ts_l_cut, e_l_cut, label_cut
        # return src_1_l_cut[idx], src_2_l_cut[idx], dst_l_cut[idx], ts_l_cut[idx], e_l_cut[idx], label_cut[idx]
    ...
    def test_samples(self, bs = None):
        ...
        src_1_l_cut, src_2_l_cut, dst_l_cut, ts_l_cut, e_l_cut, label_cut = self.test_src_1[batch_idx], self.test_src_2[batch_idx], self.test_dst[batch_idx], self.test_ts[batch_idx], self.test_idx[batch_idx], self.test_label[batch_idx]
        self.idx += 1
        # idx, label_cut = self.inter_label(label_cut)
        return src_1_l_cut, src_2_l_cut, dst_l_cut, ts_l_cut, e_l_cut, label_cut
        # return src_1_l_cut[idx], src_2_l_cut[idx], dst_l_cut[idx], ts_l_cut[idx], e_l_cut[idx], label_cut[idx]
